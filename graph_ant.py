...
road_file_path = 'vendor/Coords_ant/road.txt'
composite_file_path = 'vendor/coords_ant/composite_road.txt'
...
plt.xlabel('X')
plt.ylabel('Y')
plt.savefig('vendor/img/graph_ant.png')
plt.savefig('vendor/img/graph_ant.svg')
plt.show()
...
plt.xlabel('X')
plt.ylabel('Y')
plt.savefig('vendor/img/composite_graph_ant.png')
plt.savefig('vendor/img/composite_graph_ant.svg')
plt.show()
